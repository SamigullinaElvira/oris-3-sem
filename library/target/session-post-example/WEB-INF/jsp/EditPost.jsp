	...
	<div class="mt-3 ml-3">
		...
		<form action="" method="post" class="w-50 mx-auto">
			<div class="mb-3">
				...
				<input value="${post.getTitle()}" name="title" type="text" class="form-control" id="title">
			</div>

			<div class="mb-3">
				<label for="text" class="form-label">Текст поста</label>
				<textarea type="text" rows="9" name="text" class="form-control" id="text">${post.getText()}</textarea>
			</div>
